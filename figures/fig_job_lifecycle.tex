...
\begin{tikzpicture}[
  ...
  \node[proteablock, minimum width=30mm, right=38mm of queued.north east, anchor=north west] (coord) {Coordinator op\\\footnotesize \texttt{compute\_embeddings}\\\texttt{predict\_go\_terms}};
  ...
  \draw[proteadashed] (counter.north) to[bend left=12]
        node[pos=0.12, above right, font=\footnotesize]{closes parent} (running.east);
