...
%  Source: figures/fig_architecture.tex @ 57fa4d4
%  Static TikZ diagram. Verify fidelity against:
%    protea/api/app.py (_ROUTER_MODULES), protea/infrastructure/queue/,
%    protea/workers/, repositories/protea-backends/pyproject.toml
% ============================================================
\begin{tikzpicture}[
  ...
  % ── API layer ───────────────────────────────────────────────
  \node[proteablock, minimum width=46mm, below=of web] (api) {FastAPI REST API\\\footnotesize 19 routers · session injection};
