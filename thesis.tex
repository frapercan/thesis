...
% ── Placeholder command for pending numbers / decisions ─────
% Usage: \TODO{text describing what is pending}
% Renders inline as bold coloured text so it is hard to miss in draft mode.
