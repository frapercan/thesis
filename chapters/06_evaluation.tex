...
candidate-side lever that does pay routes around the reranker rather than into it,
scoring a generator's own proposals with the generator's own output, and is quantified
below at $+0.0084$.
