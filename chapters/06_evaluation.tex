...
grid will be reported. The grid is in progress at time of writing, with export
jobs running for the remaining PLM-$K$ combinations; final numbers will be
incorporated in the revised version before thesis submission. The multi-PLM
grid is discussed further in the limitations and future work sections.
...
\begin{itemize}
  ...
  \item The multi-PLM $\times$ $K$ generalisation grid (Exp.~9 / FARM-EXP.13)
    is in progress at time of writing; results across all 24 (PLM, $K$) cells
    are not yet complete and will be incorporated before thesis submission. The
    champion result (0.7291 $\pm$ 0.0028) is established on ProstT5 alone and
    its extension to other PLMs remains an open empirical question.
\end{itemize}
