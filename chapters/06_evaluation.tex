...
The heuristic scoring experiment (Exp.~3) already showed that layering pairwise
alignment statistics on top of the embedding-only baseline yields a consistent
1.5 to 4\% improvement, direct evidence that alignment carries signal partially
orthogonal to the learned representation. The leakage-free full-feature
