...
\begin{figure}[htbp]
  ...
  \caption[Fmax as a function of k]{%
    ...
    Source: \texttt{figures/fig\_fmax\_vs\_k.py} (data: \texttt{figures/data/fmax\_vs\_k.csv}).%
  }
  \label{fig:fmax-vs-k}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption[Re-ranker progression across methods]{%
    ...
    Source: \texttt{figures/fig\_reranker\_progression.py}
...
\begin{figure}[htbp]
  ...
  \caption[Top-10 LightGBM feature importances per category (v3, leakage-free)]{%
    ...
    Source: \texttt{figures/fig\_feature\_importance.py}
...
\begin{figure}[htbp]
  ...
  \caption[PROTEA vs eggNOG-mapper across NK/LK/PK and aspects]{%
    ...
    Source: \texttt{figures/fig\_protea\_vs\_emapper.py}
